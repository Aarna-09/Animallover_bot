...
//         const reply = R(lang,
//             `Team jaldi photos/videos bhejegi 📸 Please wait!`,
...
//     const discountKeywords = ['discount','cheap','kam karo','sasta','last price','best price','kam price','thoda kam','negotiate','bargain'];
...
//         }
//         const lidPhone = from.replace('@lid', '');
//         return { phone: lidPhone, jid: from };
//     }
...
//             const { phone, jid } = extractPhone(msg);
//             if (!phone) return;

//             if (phone === EXECUTIVE_NUMBER) return;
